...
<body>
	...
	<p>
		...
		<a href="<%=request.getContextPath()%>/ServletManipulationSession">ServletManipulatationSession (sans réécriture d'URL)</a>
	</p>
	
	<p>
		Avec le lien suivant, le suivi de session est assuré même si les cookies sont refusés :
		<a href="<%=response.encodeURL(request.getContextPath()+"/ServletManipulationSession")%>">ServletManipulatationSession (avec réécriture d'URL)</a>
	</p>
